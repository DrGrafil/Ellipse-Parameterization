...
\begin{document}
 ...
 \filldraw (-1.118,0) circle (.75pt) node[align=left,   below] {\large{Focus}};
 \draw [decorate,decoration={brace,amplitude=27.5pt,mirror,raise=2.5pt}]
(0cm,0cm) -- (2.0125,0cm) node [black,midway, below = 30pt] {\Large{$d$}};
 \filldraw (2.0125,0) circle (.75pt) node[align=left,   below right = 1pt] {};
 \filldraw (0,0) circle (.75pt) node[align=left,   below left = 2pt] {\large{$(0,0)$}};
 \end{tikzpicture}
\end{document}
